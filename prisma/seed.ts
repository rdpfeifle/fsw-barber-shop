...
async function seedDatabase() {
  try {
    ...
    // Creative names for the barbershops
    const creativeNames = [
      "Vintage Barbershop",
      "Cut & Style",
      "Beard & Razor",
    ...
    // Fake addresses for the barbershops
    const addresses = [
    ...
    const services = [
      ...
      {
        name: "Beard",
        description: "Complete grooming to enhance your masculinity.",
        price: 40.0,
        imageUrl:
    ...
    for (let i = 0; i < 10; i++) {
      ...
      const barbershop = await prisma.barbershop.create({
        data: {
          ...
          address,
          imageUrl: imageUrl,
          phones: ["(720) 99999-9999", "(720) 99999-9999"],
          description:
    ...
    console.error("Error while creating the barbershops:", error);
  }
}
